            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="flex justify-between mb-1">
                  ...
                  <span className="text-sm font-medium text-red-600">-10.3%</span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-2">
            ...
            <div className="space-y-4">
              <div>
                <div className="flex justify-between mb-1">
                  ...
                  <span className="text-sm font-medium text-gray-900">R$ 1.250,00</span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-2">
              ...
              <div>
                <div className="flex justify-between mb-1">
                  ...
                  <span className="text-sm font-medium text-gray-900">R$ 3.500,00</span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-2">
