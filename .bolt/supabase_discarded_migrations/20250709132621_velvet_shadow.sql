/*
  # Create Invites System for User Sharing

  1. New Tables
    - `invites` - Store invitation data for user sharing
  
  2. New Functions
    - `generate_invite_token()` - Generate unique tokens for invites
    - `create_invite()` - Create new invitations with proper validation

  3. Security
    - Enable RLS on the invites table
