/*
  # Create Invite System Tables and Functions

  1. New Tables
    - `invites` - Store invite records with tokens
  
  2. New Functions
    - `generate_invite_token` - Creates unique secure tokens
    - `create_invite` - Validates and creates invite records

  3. Security
    - Enable RLS with policies for user-owned invites
