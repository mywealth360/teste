/*
  # Create Invites System (Safe Version)
  
  This migration checks if structures already exist before creating them,
  avoiding errors when the migration is run multiple times.
*/
...
-- Create function to generate unique invite tokens if it doesn't exist
...
EXCEPTION
  WHEN OTHERS THEN
    -- Ignore errors if permissions were already granted
    NULL;
END $$;
