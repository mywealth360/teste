/*
  ...
  1. New Tables
    - `alert_notification_settings` - User preferences for alert notifications
    - `scheduled_email_notifications` - Queue for email notifications to be sent

  2. New Functions
    - Functions to generate and process email notifications
    - Daily and weekly digest generation
    - Immediate notification processing

  3. Security
    - Enable RLS on all new tables
    - Ensure proper access control for notification settings
*/
...
-- Since user_id is now UNIQUE in alert_notification_settings, we use INSERT...WHERE NOT EXISTS
